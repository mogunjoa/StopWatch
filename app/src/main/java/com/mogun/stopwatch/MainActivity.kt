...
import com.mogun.stopwatch.databinding.ActivityMainBinding
import com.mogun.stopwatch.databinding.DialogCountdownSettingBinding
        ...
        timer = timer(initialDelay = 0, period = 100) {
            if(currentCountdownDeciSecond == 0) {
                ...
                runOnUiThread {
                    ...
                    binding.tick.text = deciSecond.toString()
